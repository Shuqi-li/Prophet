...
# g和f的hidden_state
search_space = {
        'learning_rate': {'_type': 'choice', '_value': [5e-5, 1e-6]},
        ...
        'batch_size': {'_type': 'choice', '_value': [16]}, # config文件中目前写的64
    }

experiment = Experiment('local')
experiment.config.trial_command = 'CUDA_VISIBLE_DEVICES=4 python -m causica.run_experiment electricity --model_type rhino_informer -dc configs/dataset_config_temporal_causal_dataset_all.json --model_config configs/rhino/model_config_rhino_electricity_gaussian.json -dv gpu -i -ifc infer_config_temporal_causal_dataset.json'
