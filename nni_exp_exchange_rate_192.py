...
search_space = {
        'learning_rate': {'_type': 'choice', '_value': [1e-5, 5e-5]},
        # 'likelihoods_learning_rate': {'_type': 'choice', '_value': [1e-5, 5e-5, 1e-6]},
        'lambda_sparse':{'_type': 'choice', '_value': [0]},
        "warm_up_step":{'_type': 'choice', '_value': [200,500]},
        # "reduce_lr_step":{'_type': 'choice', '_value': [20]},
        'log_scale_init':{'_type': 'choice', '_value': [-1,-1.74,-2.5]},
        'pre_len': {'_type': 'choice', '_value': [192]},
        'max_steps_auglag': {'_type': 'choice', '_value': [200]}, # config文件中目前写的2000
        'batch_size': {'_type': 'choice', '_value': [256]}, # config文件中目前写的2000
        'random_seed': {'_type': 'choice', '_value': [0,1,2,3,4]}, # config文件中目前写的2000
    }

experiment = Experiment('local')
experiment.config.trial_command = 'CUDA_VISIBLE_DEVICES=3 python -m causica.run_experiment exchange_rate --model_type rhino_timesnet -dc configs/dataset_config_temporal_causal_dataset_all.json --model_config configs/rhino/model_config_rhino_exchange_rate_gaussian_timesnet.json -dv gpu -i -ifc infer_config_temporal_causal_dataset.json'
